...
<div id="followingbox">
<div id="heading"><b>People followed by <?php echo $firstname; ?></b></div><br>
<center>
<form action="following.php?id=<?php echo $getid; ?>" method="post">
...
$followersexplode=explode(",",$following);
$countfollowing=count($followersexplode);
...
var lastfollowingnumber=20;
$("#button").click(function()
{
	$("#ajaxload").css("display","block");
	followingnumber=followingnumber+20;
	lastfollowingnumber=lastfollowingnumber+20;
	if(lastfollowingnumber>='.$countfollowing.'-1)
	{
		$("#mybuttontab").css("display","none");
	}
	$.post("addfollowing.php",{userid:'.$getid.',countfollowing:'.$countfollowing.',followingnumber:followingnumber,lastfollowingnumber:lastfollowingnumber},function(data)
		{
